...
#ifdef INCLUDE_SDL 
	#ifdef _WIN32
		#include <C:/SDL2-2.32.0/include/SDL2/SDL.h>
	#elif __APPLE__
...
*************************************************/
	...
	#ifdef _WIN32
		#include <C:/SDL2-2.32.0/include/SDL2/SDL_image.h>
	#elif __APPLE__
		#include "TargetConditionals.h"
		#include <SDL_image.h>
	#elif __linux__
...
*************************************************/
	...
	#ifdef _WIN32
		#include <C:/SDL2-2.32.0/include/SDL2/SDL_mixer.h>
	#elif __APPLE__
		#include "TargetConditionals.h"
		#include <SDL_mixer.h>
	#elif __linux__
...
*************************************************/
	...
	#ifdef _WIN32
		#include <C:/SDL2-2.32.0/include/SDL2/SDL_ttf.h>
	#elif __APPLE__
		#include "TargetConditionals.h"
		#include <SDL_ttf.h>
	#elif __linux__
...
*************************************************/
	...
	#ifdef _WIN32
		#include <C:/SDL2-2.32.0/include/SDL2/SDL_net.h>
	#elif __APPLE__
		#include "TargetConditionals.h"
		#include <SDL_net.h>
	#elif __linux__
	...
	#undef INCLUDE_SDL_NET 
...
#ifdef INCLUDE_SDL_RENDER 
	#ifdef _WIN32
		#include <C:/SDL2-2.32.0/include/SDL2/SDL_render.h>
	#elif __APPLE__
		#include "TargetConditionals.h"
		...
		#error "Unknown compiler"
	#endif
	#undef INCLUDE_SDL_RENDER
#endif // INCLUDE_SDL_Render